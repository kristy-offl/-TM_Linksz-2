    ...
    if len(results) == 0:
        ...
        try:
            await bot.send_message(
                ...
                text=f"Found {(len_results)}. <i>Must Join Our Channel For Enjoy Our Service by clicking this <b>@colorkannadi_LinkzZ</b>. ⬇️ YOUR RESULTS ARE HERE ⬇️</i>:<code>{query}</code>",
